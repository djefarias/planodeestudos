...
async function main() {
  ...
  const materiaisData: Array<{ nome: string; link: string; categoria: string }> = [
    ...
    { nome: 'DIREITO CONSTITUCIONAL', link: 'https://drive.google.com/file/d/17pyRrpAyL4fvspZSFsVr1ohEQAzcEAwS/view?usp=drive_link', categoria: 'testes' },
    { nome: 'DIREITOS HUMANOS', link: 'https://drive.google.com/file/d/1fw0JVApMDzDvmUfC7pEd02sxez0JyP84/view?usp=drive_link', categoria: 'testes' },
    { nome: 'INFORMÁTICA', link: 'https://drive.google.com/file/d/1MT2R4ZuNbk79G4X1P_rHWV6Oa5_OZEsp/view?usp=drive_link', categoria: 'testes' },
    { nome: 'LEGISLAÇÃO PRF', link: 'https://drive.google.com/file/d/1vNHq_f6oI39ISV9gBYrf4pnAl3u_qlCi/view?usp=drive_link', categoria: 'testes' },
    ...
    { nome: 'PORTUGUÊS QUESTÕES', link: 'https://drive.google.com/file/d/12kqoLobgwtDuqvk_MRdyAOvhyJSGlGna/view?usp=drive_link', categoria: 'testes' },
  ...
  for (const md of materiaisUnicos) {
    ...
    console.log(`📚 Material: ${md.nome} (${md.categoria})`);
  }
